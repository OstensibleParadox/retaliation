...
\begin{enumerate}
    ...
    \item dynamic extension: unpriced zero-retaliation failures can propagate through dependency networks into constraint cascades whose continuum limit exhibits an Airy turning-point signature---a model-immanent asymptotic diagnostic, not an empirical identification claim.
\end{enumerate}
