...
\begin{itemize}
    \item \textbf{Sanctionable Inconsistency} (\texttt{Sanctionable\_Inconsistency.thy}):
      \begin{itemize}
        ...
        \item \texttt{consistent\_\allowbreak{}agentic\_\allowbreak{}not\_\allowbreak{}best\_\allowbreak{}response}: a consistent-agentic register (anthropomorphic on all channels) is not a best response when catastrophic liability exceeds the ontological premium.
        \item \texttt{inconsistent\_\allowbreak{}on\_\allowbreak{}path\_\allowbreak{}not\_\allowbreak{}sequentially\_\allowbreak{}rational} and \texttt{consistent\_\allowbreak{}agentic\_\allowbreak{}on\_\allowbreak{}path\_\allowbreak{}not\_\allowbreak{}sequentially\_\allowbreak{}rational}: bridge theorems showing that both register types are pruned from any sequentially rational strategy profile.
      \end{itemize}
    \item \textbf{Costly Signaling} (\texttt{Ontological\_Arbitrage.thy}):
      \begin{itemize}
