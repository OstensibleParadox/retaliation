...
sequentially rational and Bayes-consistent on path under the off-path beliefs and payoff inequalities of the pooling region. Under the off-path beliefs
